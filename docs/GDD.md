...
| **M10** | **Release readiness** | עמוד itch.io/Steam לדסקטופ; Data Safety form + נכסי Play Console לאנדרואיד | **⏳ טרם התחיל — ראה "צ'קליסט שחרור" למטה לחלוקת עבודה קוד-מול-משתמש** |
